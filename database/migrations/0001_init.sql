-- Chronicle Calendar database package v3 initial schema
-- This file is the canonical schema entry for the standalone database package.
-- UI shells, desktop runtimes, and LLM agents should all treat this schema as
-- the storage contract for the v3 database layer.
